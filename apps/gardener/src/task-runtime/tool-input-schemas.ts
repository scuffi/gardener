...
export const taskToolInputSchemas = {
  ...
  repository_list_files: v.strictObject({
    path: v.optional(v.pipe(v.string(), v.description("Repository-relative directory to list, such as src/lib; no .. and no absolute paths. Omit it, or use \".\", for the repository root."))),
