...
import { Toasty, useKumoToastManager } from "../primitives";
  ...
  const notify = useCallback(
    (notice: Notice) => {
      toastManager.add({
        ...
        // Errors persist until dismissed; the operator must acknowledge a failure.
...
export function NotificationsProvider({ children }: { children: ReactNode }) {
  return (
    <Toasty>
      <NotificationsBridge>{children}</NotificationsBridge>
    </Toasty>
  );
}
