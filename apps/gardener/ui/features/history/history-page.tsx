...
import { EmptyState, ErrorState, PageHeader, Panel, RunStatus, TableSkeleton } from "../../primitives";
            ...
            {items.map((item) => (
              ...
              >
                ...
                <article className="min-w-0 rounded-md border border-kumo-hairline bg-kumo-elevated p-3.5">
                  ...
                  {item.actor ? (
                    <small className="mt-2 block text-xs text-kumo-subtle">Actor: {item.actor}</small>
                  ) : null}
                </article>
              </li>
            ))}
