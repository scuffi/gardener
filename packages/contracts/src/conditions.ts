...
export const workflowConditionCapabilitySpecifications = [
  ...
  { id: "github.event.actor.identity@v1", valueType: "identity", scalarType: "identity", operators: identityOperators, eventKinds: ["github.issue", "github.pull_request"], availability: "available" },
  { id: "github.event.actor.login@v1", valueType: "string", scalarType: "string", operators: scalarOperators, eventKinds: ["github.issue", "github.pull_request"], availability: "available" },
  { id: "github.event.actor.account_type@v1", valueType: "string", scalarType: "account_type", operators: scalarOperators, eventKinds: ["github.issue", "github.pull_request"], availability: "available" },
  { id: "github.resource.author.identity@v1", valueType: "identity", scalarType: "identity", operators: identityOperators, eventKinds: ["github.issue", "github.pull_request"], availability: "available" },
  ...
  { id: "github.resource.author.account_type@v1", valueType: "string", scalarType: "account_type", operators: scalarOperators, eventKinds: ["github.issue", "github.pull_request"], availability: "available" },
