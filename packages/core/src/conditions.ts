...
const presentations: Record<WorkflowCapabilityId, CapabilityPresentation> = {
  ...
  "github.event.actor.identity@v1": { label: "Person or App that caused this event", description: "Planned negotiated event identity; unavailable on the legacy v1 wire format.", category: "event_actor", provenance: "connect-attested-identity", trust: "identity", requiredGitHubPermission: undefined },
  "github.event.actor.login@v1": { label: "Event actor login hint", description: "Planned mutable display login for the GitHub webhook sender; not a security identifier.", category: "event_actor", provenance: "github-content", trust: "content", requiredGitHubPermission: undefined },
  "github.event.actor.account_type@v1": { label: "Event actor account type", description: "Planned negotiated GitHub account type for the webhook sender.", category: "event_actor", provenance: "connect-attested-identity", trust: "identity", requiredGitHubPermission: undefined },
  "github.resource.author.identity@v1": { label: "Original issue or pull request author", description: "Planned stable numeric identity and account type for the resource author.", category: "resource_author", provenance: "connect-attested-identity", trust: "identity", requiredGitHubPermission: undefined },
  ...
  "github.resource.author.account_type@v1": { label: "Resource author account type", description: "Planned negotiated GitHub account type for the original resource author.", category: "resource_author", provenance: "connect-attested-identity", trust: "identity", requiredGitHubPermission: undefined },
